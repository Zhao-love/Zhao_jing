...
<超文本标记语言><头><自指的http-equiv="内容类型" 内容=“文本/html；字符集=UTF-8 ">
    
    <title>💗 Love you Jing 💗</title>
    <style type="text/css">
    正文{
    边距:0；
    溢出:隐藏；
    ...
    #pinkboard {
    动画:anim 1.5s ease-in-out无限；
    -WebKit-动画:anim 1.5s ease-in-out infinite；
    -o-animation:anim 1.5s ease-in-out无限；
    -moz-animation:anim 1.5s ease-in-out无限；
      }
    @关键帧动画{
        0% {
    变换:缩放(0.8)；
  ...
  <body>
    ...
    <script>
      ...
      // 参��：https://blog.csdn.net/weixin_57038822/article/details/121644240
    </script>
  

<div id="__FEISHU_CLIPPER__"></div></body></超文本标记语言>
